...
from rlkit.policy import PPOMAMLPolicy
...
def get_args():
    ...
    parser.add_argument("--algo-name", type=str, default="ppo-maml")
    ...
    parser.add_argument('--actor-hidden-dims', default=(32, 32))
