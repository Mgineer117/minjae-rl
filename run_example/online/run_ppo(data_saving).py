...
def get_args():
    ...
    parser.add_argument('--episode_len', type=int, default=5000)
    parser.add_argument('--episode_num', type=int, default=2)
    parser.add_argument("--eval_episodes", type=int, default=3)
    parser.add_argument("--save-rendering", type=bool, default=True)
...
def train(args=get_args()):
    ...
    for seed in args.seeds:
        ...
        critic_backbone = MLP(input_dim=np.prod(args.obs_shape), activation=torch.nn.Tanh, hidden_dims=args.hidden_dims)
